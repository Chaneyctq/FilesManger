...
class SandboxFileEditorPage extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('保存');
            Text.fontColor({ "id": 16777233, "type": 10001, params: [], "bundleName": "com.example.filesmanger", "moduleName": "entry" });
            Text.fontSize(16);
            Text.maxLines(1);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextArea.backgroundColor({ "id": 16777235, "type": 10001, params: [], "bundleName": "com.example.filesmanger", "moduleName": "entry" });
